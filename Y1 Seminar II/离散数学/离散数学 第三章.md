...
- 设$A, B$是两个集合，$A$与$B$的差$A- B$，对称差A由B定义如下：
  ...
  >
  > <img src="C:/Users/Thomas/Desktop/离散数学.assets/image-20200325134458324.png" alt="image-20200325134458324" style="zoom:75%;" />
  >
...
- eg:
  ...
  <img src="C:/Users/Thomas/Desktop/离散数学.assets/image-20200325161352869.png" alt="image-20200325161352869" style="zoom:75%;" />

  R 和S 的关系图如图（a）和图（b）所示。

  <img src="C:/Users/Thomas/Desktop/离散数学.assets/image-20200325161428282.png" alt="image-20200325161428282" style="zoom:75%;" />
...
- 设$R$是从集合$A$到集合$B$的关系，则从$B$到$A$的关系
  ...
  - *转置矩阵*
    ...
    ![image-20200325171550449](C:/Users/Thomas/Desktop/离散数学.assets/image-20200325171550449.png)
